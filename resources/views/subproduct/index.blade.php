...
@section('content')
 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <div style="margin-top:10px" align='right'><a href="#editSubProduct" rel="modal:open" data-id="0" data-toggle="tooltip" title="Agregar" class="add btn btn-primary add-subproduct">Agregar</a></div>
